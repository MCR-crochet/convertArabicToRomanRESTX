...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("convertarabictoromanrestx ConvertArabicToRomanRESTX 485e15e1-f8a8-45bf-a7a9-51e9cf59fba4 -4885798709379533673".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in ineat package as a set of config entries
        return configLoader.fromResource("ineat/settings");
    }
